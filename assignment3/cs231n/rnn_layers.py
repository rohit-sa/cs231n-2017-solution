...
def rnn_step_forward(x, prev_h, Wx, Wh, b):
    ...
    ##############################################################################
    x_out = np.dot(x.reshape(x.shape[0], -1), Wx) 
    h_out = np.dot(prev_h.reshape(prev_h.shape[0], -1), Wh)
    next_h = np.tanh(x_out + h_out + b.T)
...
def lstm_step_forward(x, prev_h, prev_c, Wx, Wh, b):
    ...
    cache = next_h, next_c, prev_h, prev_c, i, f, o, g, Wx, Wh, x
    pass
    ##############################################################################
    #                               END OF YOUR CODE                             #
    ##############################################################################
...
def lstm_step_backward(dnext_h, dnext_c, cache):
    ...
    #############################################################################
    next_h, next_c, prev_h, prev_c, i, f, o, g, Wx, Wh, x = cache
